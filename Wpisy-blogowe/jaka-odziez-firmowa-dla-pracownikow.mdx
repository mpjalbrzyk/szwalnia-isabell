...
schema:
  ...
  questions:
    ...
    - question: "Czy da się uszyć odzież w dokładnym kolorze z brandbooka firmy?"
      answer: "Przy małych partiach nie. Farbowanie dzianiny na zamówiony odcień ma minima liczone w setkach kilogramów materiału, więc przy kilkudziesięciu sztukach wybiera się najbliższy dostępny kolor z oferty dostawcy. Dopasowanie do brandbooka jest realne dopiero przy dużych, powtarzalnych zamówieniach."
    - question: "Co z domówieniem odzieży za rok, gdy zespół się powiększy?"
      answer: "Decydują wykroje. Formy przygotowane pod konkretny model są własnością klienta i na życzenie są zwracane, ale częściej zostają w szwalni, dzięki czemu domówienie idzie z tych samych form bez ponownej konstrukcji. Materiał to osobna kwestia: partia dzianiny się kończy, więc po dłuższym czasie możliwa jest minimalna różnica odcienia."
relatedPosts:
...
Jeśli rozważasz szycie od podstaw zamiast gotowej bazy, [napisz do nas](/kontakt.html) z opisem tego, czego szukasz: typ wyrobu, liczba sztuk, warunki, w jakich odzież ma być noszona. Odpowiemy, czy w tym wypadku szycie ma sens, czy taniej wyjdzie Ci gotowy produkt ze znakowaniem.
