...
**Który błąd przy zlecaniu szycia kosztuje najwięcej?**
Pominięcie próbki przeszyciowej i wejście od razu w produkcję seryjną. Wada wykryta na jednej sztuce to koszt jednej sztuki, ta sama wada wykryta po odbiorze partii to koszt całej partii. Próbka na własnym materiale jest najtańszym ubezpieczeniem w całym procesie i solidna szwalnia jej nie odmówi.
