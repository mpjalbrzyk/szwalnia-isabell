...
schema:
  ...
  questions:
    ...
    - question: "Przy jakiej wielkości zamówienia różnica cenowa wobec Azji przestaje mieć znaczenie?"
      answer: "Poniżej około 500 sztuk różnica kurczy się na tyle, że przestaje być argumentem. Sama stawka za robociznę w Azji jest niższa, ale dochodzą fracht liczony za kontener, cło 12 procent, VAT oraz ryzyko partii, której nie da się poprawić na miejscu. Przy małych i średnich nakładach te pozycje rozkładają się na niewiele sztuk, więc pochłaniają oszczędność na robociźnie."
