...
2. 📋 **NASTĘPNA SESJA (ustalone 08.08) — cztery rzeczy:**
   - 🎨 **Grafiki Higgsfield** (czeka na doładowanie kredytów): śródtekstowa do `/rodzaje-sciegow-maszyny-szwalnicze.html` (różnica między podwinięciem renderką a szwem overlockowym) oraz **własne hero + śródtekstowa** do `/metkowanie-odziezy-co-musi-byc-na-metce.html` i `/szwalnia-z-wlasna-krojownia.html`, które mają obecnie kadry z istniejących zasobów. Preset: `nano_banana_pro`, 3:2, 2k, hero 2000×1333 webp ≤140 KB, śródtekstowa 1440×966 ≤120 KB, OG 1200×630 jpg.
   - ⚠️ **Decyzja o obcym logo:** `assets/metkowanie-pakowanie-odziez.webp` ma widoczne **„THE TAILOR'S CO"** na czterech pudełkach i siedzi na `/uslugi/krojenie-wykonczenie.html` w sekcji „Metkowanie i pakowanie" **od maja**. Do podmiany albo świadomego zostawienia.
