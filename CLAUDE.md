...
2. 📋 **SESJA 09.08 — zostały dwie rzeczy z czterech:**
   ...
   - 📣 **WYEKSPONOWANIE KALKULATORA WEWNĄTRZ WPISÓW BLOGOWYCH** (prośba Michała 08.08). Ma to być **stały, wizualnie wyróżniony element**, nie zwykły link w akapicie. **Powód:** kalkulator jest de facto lead magnetem tego serwisu (daje wartość przed kontaktem i kwalifikuje zgłoszenie, zgłoszenia z niego mają pełny kontekst zamiast „ile kosztuje uszycie bluzy"), a linkują do niego **2 wpisy z 25**. Michał świadomie wybrał tę drogę **zamiast newslettera** (patrz punkt niżej). Warunek: element ma być transparentny, czyli jawnie mówić, że to kalkulator wyceny, bez udawania treści redakcyjnej. Uwaga przy projektowaniu: kalkulator obsługuje **żakiet, sukienkę, płaszcz, kurtkę** — NIE bluzy i NIE polo, więc na wpisach o odzieży firmowej sformułowanie musi to uwzględniać.
